...
var Pages = {
    render: function (c) {
      ...
      for (var pageId in self.pages) {
        ...
        pages.push(c(page.component, {tag: 'component', props: self.$f7Route && self.$f7Route.params, key:pageId}));
      }
      return c('div',
        {
          staticClass: 'pages',
...
var LinkMixin = {
    data: function () {
      return {
        routeInfo: {
          activeTab: this.$f7Route && this.$f7Route.route.tab
        }
      };
    },
    props: {
...
var Tab = {
    ...
    render: function (c) {
      ...
      return c('div', {
        ...
        [activeTab && activeTab.tabId === self.id ? c(activeTab.component, {tag: 'component', props: self.$f7Route.params}) : self.$slots.default]
      );
    },
    methods: {
      show: function (animated) {
  ...
  install: function (Vue, parameters) {
    ...
    Vue.mixin({
      beforeCreate: function () {
        ...
        // Route
        Object.defineProperty(self, '$f7Route', {
          get: function () { return console.log('get route'); currentRoute; },
          enumerable: true,
          configurable: true
        });

        Object.defineProperty(self, '$f7router', {
          get: function () { return router; debugger },
          enumerable: true,
          configurable: true
        });
        Object.defineProperty(self, '$f7Router', {
      ...
      mounted: function () {
        ...
        if (f7Ready) {
          ...
          initFramework7(self.$root.$options.framework7);
        }
...
export default this.Framework7Vue
